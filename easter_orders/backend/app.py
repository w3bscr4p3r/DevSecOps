...
def create_app(database_uri: str | None = None) -> Flask:
    ...
    def create_order():
        ...
        order = Order(
            ...
            due_date=parse_date(data.get("delivery_forecast") or data.get("due_date")),
...
def serialize_order(order: Order) -> dict:
    return {
        ...
        "delivery_forecast": order.due_date.isoformat() if order.due_date else None,
        "due_date": order.due_date.isoformat() if order.due_date else None,
        "order_date": order.created_at.isoformat(timespec="minutes"),
        "notes": order.notes,
